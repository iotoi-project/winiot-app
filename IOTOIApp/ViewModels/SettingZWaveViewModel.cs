...
{
    public class SettingZWaveViewModel : ViewModelBase
    {
        ...
        //}
        public void SetupZWaveController()
        {
            // Destover Go
        }
        ...
        private void PlugPowerOn(ZigBeeEndPoint endPoint)
        {
            ...
            {
                Debug.WriteLine(e.Message, "ZWave Plug Power On Exception : ");
            }
        }
        ...
        private void PlugPowerOff(ZigBeeEndPoint endPoint)
        {
            ...
            {
                Debug.WriteLine(e.Message, "ZWave Plug Power Off Exception : ");
            }
        }
        ...
        private void Disconnect(ZigBeeEndDevice endDevice)
        {
            ...
            if (endDevice == null || false == endDevice.IsConnected) return;
